 ...
 */
public class Income extends Money implements Parcelable{
    ...
    public Income(int id, Account idAccount, Catalog idCatalog, TypeMoney idMoneyType, String strName, double price) {
